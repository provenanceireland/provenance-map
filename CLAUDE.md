...
- **Provenance Featured (paid, gold):** Rich gold — `#E0B93C` (deliberately brighter and more saturated than the `#C4A44A` gold token, which the Seal tiers keep), 9.04px dot (8.93px on mobile), 3% larger than Verified, cream border (`1px solid rgba(255,250,228,0.80)`), fine gold ring plus a soft two-stage golden glow (`box-shadow: 0 0 0 1px rgba(245,219,130,0.60), 0 0 8px 2.5px rgba(224,185,60,0.72), 0 0 17px 6px rgba(224,185,60,0.30)`). **Static, not pulsing.** The visit-gated €49/month farm tier. Card pill "Provenance Featured" in `#EFCE63`. Set `"tier": "featured"` in producers.json. Unlocks the photo gallery, Instagram + website links, where-to-buy, and the filmed-visit video on the card — none of which are wired in yet. Currently: Skehana Hill.
