...
- **Provenance Featured (paid, gold):** Rich gold — `#E9C93E` (deliberately brighter and less orange than the `#C4A44A` gold token, which the Seal tiers keep; #C4A44A sits at 44 degrees hue and reads brassy, this sits at 49 and reads gold), 9.04px dot (8.93px on mobile), 3% larger than Verified, cream border (`1px solid rgba(255,252,232,0.80)`), fine gold ring plus a soft two-stage golden glow (`box-shadow: 0 0 0 1px rgba(248,232,150,0.60), 0 0 8px 2.5px rgba(233,201,62,0.72), 0 0 17px 6px rgba(233,201,62,0.30)`). **Static, not pulsing.** The visit-gated €49/month farm tier. Card pill "Provenance Featured" in `#F1D65F`. Set `"tier": "featured"` in producers.json. Unlocks the photo gallery, Instagram + website links, where-to-buy, and the filmed-visit video on the card — none of which are wired in yet. Currently: Skehana Hill.
