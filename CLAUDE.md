...
- **Provenance Featured (paid, gold):** Gold — the brand Gold token `#C4A44A`, **8.78px dot (8.67px on mobile), exactly the same size as Verified**, **no border** (unlike Discovered and Verified, which both carry a cream/white one), a fine gold ring and a strong two-stage gold glow (`box-shadow: 0 0 0 1.2px rgba(226,199,116,0.75), 0 0 12px 4px rgba(196,164,74,0.82), 0 0 24px 9px rgba(196,164,74,0.38)`). **Size does no work here — colour and glow are the entire signal**, so the glow is deliberately about double Verified's reach with an outer halo on top. This one went through several passes (3% larger, then brighter golds `#E0B93C` and `#E9C93E`, then a green-with-gold core `#6FB35A`) before settling on brand gold at Verified size. **Static, not pulsing.** The visit-gated €49/month farm tier. Card pill "Provenance Featured" in `#D9BC5E`, a lifted `#C4A44A` for legibility on the dark card. Set `"tier": "featured"` in producers.json. Unlocks the photo gallery, Instagram + website links, where-to-buy, and the filmed-visit video on the card — none of which are wired in yet. Currently: Skehana Hill.
