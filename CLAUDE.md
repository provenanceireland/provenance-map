...
- **Provenance Founder:** An additional pill (`data-badge2="Provenance Founder"`) on the card, shown **to the right of the tier pill on the same line** (gold, `.tier-pill-founder`). No special pin treatment — pin appearance is controlled by tier. Currently: Newbard Organic Farm Ltd, Staffords Butchers, and Saltrock Dairy Farm (all Verified).
