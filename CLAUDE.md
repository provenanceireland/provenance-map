...
- **Provenance Featured (paid, gold):** Green with a gold hue — core `#6FB35A`, a green pulled 24 degrees toward gold from the Verified green (`#59A666`), 9.04px dot (8.93px on mobile), 3% larger than Verified, cream border (`1px solid rgba(255,252,232,0.80)`), and a **gold ring plus a warm gold-green glow** which is what carries the premium signal (`box-shadow: 0 0 0 1.2px rgba(233,201,62,0.85), 0 0 8px 2.5px rgba(206,186,84,0.62), 0 0 17px 6px rgba(150,176,74,0.28)`). It went through solid gold first (`#C4A44A`, then `#E0B93C`, then `#E9C93E`) before landing on green-with-gold, so the pin stays in the producer green family and the gold reads as an accolade rather than a different species of pin. **Static, not pulsing.** The visit-gated €49/month farm tier. Card pill "Provenance Featured" in `#F1D65F`. Set `"tier": "featured"` in producers.json. Unlocks the photo gallery, Instagram + website links, where-to-buy, and the filmed-visit video on the card — none of which are wired in yet. Currently: Skehana Hill.
